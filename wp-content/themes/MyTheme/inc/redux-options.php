...
$opt_name = 'wp1_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Redux Options', 'redux-framework-demo' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Redux Options', 'redux-framework-demo' ),
...
Redux::set_section(
    ...
    'customizer_width' => '450px',
      ...
      [
        ...
        'subtitle' => __('Insert Eamil', 'redux-framework-demo'),
...
Redux::set_section(
  ...
  [
    ...
    'subsection'    => true,
    'customizer'    => '450px',
    'desc'          => __('Social links', 'redux-frame-work'),
    'fields'        => [
      [
        'id'         => 'fb',
        'type'      => 'text',
  ...
  [
    ...
    'fields'            => [
      [
        ...
        'desc' => __('GET IN TOUGHT', 'redux-framework-demo')
      ],
      [
        'id' => 'title_two',
        'type' => 'text',
        'title' => __('Title for bloks with links', 'redux-framework-demo'),
        'subtitle' => __('Insert the title', 'redux-framework-demo'),
        'desc' => __('Links', 'redux-framework-demo')
      ],
      [
        'id' => 'title_three',
        'type' => 'text',
        'title' => __('Car gallery', 'redux-framework-demo'),
        'subtitle' => __('Insert the title', 'redux-framework-demo'),
      ...
      [
        'id' => 'about_footer',
        'type' => 'editor',
        'title' => __('About section text', 'redux-framework-demo'),
