...
function get_breadcrumbs() {
	...
	$text['home']     = __('Home','winter');
	$text['category'] = __('Archive','winter').' "%s"';
	$text['search']   = __('Search results','winter').' "%s"';
	$text['tag']      = __('Tag','winter').' "%s"';
	$text['author']   = __('Author','winter').' %s';
	$text['404']      = __('Error 404','winter');
