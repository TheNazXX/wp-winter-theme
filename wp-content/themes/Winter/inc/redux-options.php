...
$args['admin_bar_links'][] = array(
	'id'    => 'winter',
	'href'  => '#',
	'title' => __( 'Documentation', 'winter' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '#',
	'title' => __( 'Support', 'winter' ),
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header & Footer options', 'winter' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'Data to be displayed in header logo', 'winter' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'             => esc_html__( 'Post Type Settings', 'winter' ),
		'id'                => 'post_type_settings_page',
		'desc'							=> 'Specify the count on archives',
		'icon'              => 'el el-asl',
		'customizer_width'  => '400px',
		'fields' => [
			[
				'id'       => 'rooms_count',
				'type'     => 'text',
				'title'    => esc_html__( 'Post per page', 'winter' ),
				'subtitle' => esc_html__( 'On Rooms post type', 'winter' ),
				'desc'		 => esc_html__( 'How many post to show on archive page', 'winter'),
				'default'  => 6,
				'validate' => 'numeric'
			]
		]
